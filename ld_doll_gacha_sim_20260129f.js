...
function ensureStepTabs(){
  // HTML側に step-tabs があるので、JSで追加のstepbarは作らない
...
function wireEvents(){
  ...
  if(stepTabs && !stepTabs.dataset.bound){
    stepTabs.dataset.bound='1';
    stepTabs.addEventListener('click',(e)=>{
      const b=e.target.closest('.step-tabs__dot'); 
