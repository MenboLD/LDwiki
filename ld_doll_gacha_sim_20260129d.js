...
/* LD_DBLTAP_SUPPRESS:20260129d */
(function setupDoubleTapSuppress(){
  let lastTouchEnd = 0;
  document.addEventListener('touchend', function(e){
    const t = e.target;
    const interactive = t && (t.closest?.('button,a,.doll-card,.slot-card,.tab-btn,.grade-btn,.page-btn,.controls,.modal'));
