...
function renderTreasureDetail(){
  ...
  for(const r of rows){
    ...
    l.textContent = normTreasureText(r) || '（名称なし）';
    h.appendChild(l);
    const c = document.createElement('div');
    c.className = 'fieldContent';
    const v = document.createElement('div');
    v.className = 'outVal mono';
    v.textContent = String(normTreasureVal(r) ?? '');
    c.appendChild(v);
    line.appendChild(h);
    line.appendChild(c);
