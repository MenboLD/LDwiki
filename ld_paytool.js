(async () => {
  ...
  function buildResourceToggleUI(){
    ...
    // bind once (avoid listener duplication when UI is rebuilt)
    if(!elToggles.dataset.boundChange){
      ...
      elToggles.dataset.boundChange = '1';
    }
  }
  ...
  function buildDoubleAvailabilityUI(){
    ...
    if(!elDoubleToggles.dataset.boundChange){
      elDoubleToggles.addEventListener('change', (e)=>{});
      elDoubleToggles.dataset.boundChange='1';
    }
  }
  ...
  function buildRateEditorUI(){
    ...
    if(!elRateEditor.dataset.boundChange){
      elRateEditor.addEventListener('change', (e)=>{});
      elRateEditor.dataset.boundChange='1';
    }
  }
