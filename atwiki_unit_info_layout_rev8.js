...
(function () {
  ...
  function buildSkillTableHtml(skill) {
    return [
      ...
      '  <colgroup>',
      '    <col class="ld-skill-info__col ld-skill-info__col--1">',
      '    <col class="ld-skill-info__col ld-skill-info__col--2">',
      '    <col class="ld-skill-info__col ld-skill-info__col--3">',
      '    <col class="ld-skill-info__col ld-skill-info__col--4">',
      '  </colgroup>',
      '  <tbody>',
      '    <tr>',
